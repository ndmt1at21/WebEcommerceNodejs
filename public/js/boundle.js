...
exports.reset = exports.login = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Login fail');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context2.t0.respone.message);
...
exports.fetchData = exports.rowProductHtml = void 0;
...
var rowProductHtml = function rowProductHtml(img, productName, url, price, priceDiscount) {
  return "<tr><td><div class=\"thumb_cart\"><img id=\"thumb_cart_small\" src=\"img/products/".concat(img, "\"     data-src=\"img/products/shoes/1.jpg\" class=\"lazy\" alt=\"").concat(url, "\"></div><span class=\"item_cart\">").concat(productName, "</span>    </td><td><strong>").concat(price, "</strong></td><td><div class=\"numbers-row\">    <input type=\"text\" value=\"1\" id=\"quantity_1\" class=\"qty2\" name=\"quantity_1\">    <div class=\"inc button_inc\">+</div><div class=\"dec button_inc\">-</div></div>    </td><td><strong>").concat(price, "</strong></td><td class=\"options\"><a href=\"#\"><i class=\"ti-trash\"></i></a>    </td></tr>");
};

exports.rowProductHtml = rowProductHtml;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/racket/".concat(productID)
            });
...
var loginForm = document.querySelector('.form_container');
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  if (emailForgot) (0, _login.reset)(emailForgot);else (0, _login.login)(email, password);
});
