...
exports.register = exports.reset = exports.login = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            (0, _alert.showAlert)('success', 'Please check your email to reset your password');
            _context2.next = 11;
            break;
...
var register = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(email, password, name, lastName, address, phone) {
    var res;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            url = "http://127.0.0.1:8002/api/v1/racket?_id=";
            query = '';
            IDs.map(function (id) {
...
exports.deleteProduct = exports.incProduct = exports.decProduct = exports.updateQuantity = exports.getIDs = exports.setProducts = exports.getProducts = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:8002/api/v1/racket/".concat(racketID, "/review"),
              data: {
                rating: star,
                title: title,
                content: content
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"product-detail.js":[function(require,module,exports) {
////////////////////////////////////
//// SELECTOR
var addToCartBtn = document.getElementById('btn-add-cart');
var quantityCart = document.getElementById('quantity_1');
var rowReview1 = document.getElementById('row_review_1');
var rowReview2 = document.getElementById('row_review_2');
...
if (pagination) {
  pagination.addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = "?page=".concat(e.target.getAttribute('value'));
  });
}
...
var _productDetail = require("./product-detail");
...
/////////////////////////////////////////////////
// SELECTOR
var seachForm = document.querySelector('.custom-search-input');
...
if (seachForm) {
  seachForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var query = "/search/?keyword=".concat(seachForm.firstChild.value);
...
if (loginForm) /////////////////////////////////////////////////
  ...
  loginForm.addEventListener('submit', function (e) {
    ...
    if (emailForgot) (0, _auth.reset)(emailForgot);else (0, _auth.login)(email, password);
  });
...
if (cardReview) {
  ...
  (0, _productDetail.showReviews)(racketID, 1);
}
