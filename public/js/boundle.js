...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var divHtml = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
...
exports.reset = exports.forgot = exports.logout = exports.register = exports.login = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', "Login fail: ".concat(_context.t0.message));
...
var register = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(email, password, name, lastName, address, phone) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('Error logging out');
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Vui lòng kiểm tra email (có thể trong hòm thư rác) để xác nhận');
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Lỗi: không thể gửi email xác nhận');
...
var reset = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(newPassword, passwordConfirm, token) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            (0, _alert.showAlert)('error', 'Bạn hãy điền đầy đủ thông tin');
          ...
          case 3:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/user/reset/".concat(token),
              data: {
          ...
          case 6:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Reset mật khẩu thành công');
              setTimeout(function () {
                window.location.assign('/');
              }, 1000);
            } else {
              (0, _alert.showAlert)('error', err.data.message);
            }
          ...
          case 10:
            ...
            (0, _alert.showAlert)('error', 'Không thể reset mật khẩu');
  ...
  return function reset(_x10, _x11, _x12) {
    return _ref5.apply(this, arguments);
  };
}();

exports.reset = reset;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"fetchDataRackets.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchDataRackets = void 0;
...
var fetchDataRackets = /*#__PURE__*/function () {
          ...
          case 2:
            ...
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              (0, _axios.default)({
                ...
                return resolve(res.data.data.rackets);
              }).catch(function (err) {
  ...
  return function fetchDataRackets(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.fetchDataRackets = fetchDataRackets;
},{"axios":"../../node_modules/axios/index.js"}],"formatter.js":[function(require,module,exports) {
"use strict";
...
var formatter = Intl.NumberFormat('vi-VN', {
  style: 'currency',
  currency: 'VND'
});
exports.formatter = formatter;
},{}],"cartInLocalStorage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteProduct = exports.incProduct = exports.decProduct = exports.updateQuantity = exports.getIDs = exports.setProduct = exports.setProducts = exports.getProducts = void 0;
...
var setProducts = function setProducts(productsObj) {
  localStorage.setItem('cart', JSON.stringify(productsObj));
};

exports.setProducts = setProducts;

var setProduct = function setProduct(id, quantity) {
...
var getIDs = function getIDs() {
  var productsInCart = getProducts();
  var IDs = [];

  for (var id in productsInCart) {
    IDs.push(id);
  }
...
var updateQuantity = function updateQuantity(id, quantity) {
  ...
  if (products[id]) {
    if (quantity <= 0) delete products[id];else products[id] = quantity;
    setProducts(products);
  }
};
...
var decProduct = function decProduct(id) {
  var products = getProducts();
...
exports.decProduct = decProduct;

var incProduct = function incProduct(id) {
  var products = getProducts();
...
exports.updateCartTable = void 0;

var _fetchDataRackets = require("./fetchDataRackets");

var _formatter = require("./formatter");

var _cartInLocalStorage = require("./cartInLocalStorage");
...
},{"./fetchDataRackets":"fetchDataRackets.js","./formatter":"formatter.js","./cartInLocalStorage":"cartInLocalStorage.js"}],"header.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateCartNotifi = void 0;
...
var rowProductInCart = function rowProductInCart(racket, numProduct) {
  var imgUrl = '';

  if (racket.imageCover.startsWith('http')) {
    imgUrl = racket.imageCover;
  } else {
    imgUrl = "./img/products/".concat(racket.imageCover);
  }

  return "<li>\n            <a href=\"/".concat(racket.slug, ".").concat(racket._id, "\">\n              <figure>\n                <img\n                  class=\"lazy\"\n                  src=\"").concat(imgUrl, "\"\n                  data-src=\"img/products/shoes/thumb/1.jpg\"\n                  alt=\"").concat(racket.slug, "\"\n                  width=\"50\"\n                  height=\"50\"\n                ></img>\n              </figure>\n              <strong><span style=\"overflow: hidden;\"> ").concat(numProduct, " x ").concat(racket.name, " </span>").concat(_formatter.formatter.format(racket.price * numProduct), " </strong>\n            </a>\n          </li>");
};

var notifiNumProduct = document.querySelector('.cart_bt');
var cartList = document.querySelector('.cart_bt+.dropdown-menu>ul');
var shoppingCarts = document.querySelectorAll('i.ti-shopping-cart');
cartList.addEventListener('click', function (e) {
  console.log('dfjhhj');
});

var updateCartNotifi = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var productsInCart, IDs, rackets, count;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            notifiNumProduct.insertAdjacentHTML('afterbegin', "<strong>".concat(rackets.length, "</strong>"));
            ...
            rackets.forEach(function (racket) {
              if (count >= 4) return;
              cartList.insertAdjacentHTML('afterbegin', rowProductInCart(racket, productsInCart[racket._id]));
              count++;
            });
  ...
  return function updateCartNotifi() {
    return _ref.apply(this, arguments);
  };
}();

exports.updateCartNotifi = updateCartNotifi;
...
if (shoppingCarts) {
  shoppingCarts.forEach(function (shoppingCart) {
    shoppingCart.addEventListener('click', /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
        var urlProduct, id, cartSaved, cart;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                e.preventDefault();
                urlProduct = shoppingCart.getAttribute('value');
                id = urlProduct.slice(urlProduct.lastIndexOf('.') + 1);
                cartSaved = JSON.parse(localStorage.getItem('cart')) || {};
                if (!cartSaved[id]) cartSaved[id] = 1;
                cart = JSON.stringify(cartSaved);
...
},{"./fetchDataRackets":"fetchDataRackets.js","./formatter":"formatter.js","./cartInLocalStorage":"cartInLocalStorage.js"}],"leave-review.js":[function(require,module,exports) {
"use strict";
...
var sendReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(star, title, content, racketID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/racket/".concat(racketID, "/review"),
              data: {
                rating: star,
                title: title,
                content: content
          ...
          case 3:
            res = _context.sent;
            (0, _alert.showAlert)('success', 'Đăng nhận xét thành công');
            _context.next = 11;
            break;
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0);
            (0, _alert.showAlert)('error', 'Không thể đăng nhận xét ngay lúc này!');
...
var updateSetting = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form, type) {
    var urlApi, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlApi = type === 'info' ? '/api/v1/user/updateMe' : '/api/v1/user/updatePassword';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Cập nhật thông tin thành công');
              setTimeout(function () {
...
var _leaveReview = require("./leave-review");
...
/////////////////////////////////////////////////
// SELECTOR
var searchForm = document.querySelector('.custom-search-input');
var loginForm = document.getElementById('form_login');
var registerForm = document.getElementById('form_register');
var tableCartBody = document.querySelector('#cart-table > tbody');
var reviewForm = document.getElementById('form_review');
var cardReview = document.getElementById('card_body_review');
var pagination = document.querySelector('.pagination');
var logoutButton = document.getElementById('logout');
var formReset = document.getElementById('reset_password');
var formUpdateInfo = document.getElementById('formUpdateInfo');
var formUpdatePassword = document.getElementById('formUpdatePassword');

if (searchForm) {
  searchForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var query = "/search?keyword=".concat(searchForm.firstChild.value);
...
if (loginForm) /////////////////////////////////////////////////
  ...
  loginForm.addEventListener('submit', function (e) {
    ...
    var emailForgot = document.getElementById('email_forgot').value;

    if (emailForgot) {
      (0, _auth.forgot)(emailForgot);
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    var addr = document.getElementById('addr_register').value;
    var phone = document.getElementById('phone_register').value;
    (0, _auth.register)(email, password, name, lastname, addr, phone);
  });
}
...
if (reviewForm) {
  reviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var star, title, content, slugID;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              star = document.querySelectorAll('.rating-input:checked')[0].value;
              title = document.getElementById('title-review').value;
              content = document.getElementById('content-review').value;
              slugID = window.location.pathname.toString().split('/')[1];
              _context.next = 7;
              return (0, _leaveReview.sendReview)(star, title, content, slugID.split('.')[1]);
...
if (pagination) {
  pagination.addEventListener('click', function (e) {
    e.preventDefault();
    var racketID = window.location.pathname.split('.')[1];
...
if (formReset) {
  formReset.addEventListener('submit', function (e) {
    ...
    (0, _auth.reset)(newPassword, passwordConfirm, token);
  });
}

if (formUpdateInfo) {
  formUpdateInfo.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var formData;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              (0, _updateSettings.updateSetting)(formData, 'info');
...
if (formUpdatePassword) {
  formUpdatePassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var currentPassword, password, passwordConfirm, formData;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              (0, _alert.showAlert)('error', 'Các trường nhập là bắt buộc');
              return _context3.abrupt("return");

            case 7:
              if (!(currentPassword.length < 8 || password.length < 8 || passwordConfirm.length < 8)) {
                _context3.next = 10;
                break;
              }

              (0, _alert.showAlert)('error', 'Mật khẩu phải lớn hơn 8 ký tự');
              return _context3.abrupt("return");
            ...
            case 10:
              ...
              (0, _alert.showAlert)('error', 'Mật khẩu mới giống với mật khẩu hiện tại');
              return _context3.abrupt("return");
            ...
            case 13:
              ...
              (0, _updateSettings.updateSetting)(formData, 'password');
