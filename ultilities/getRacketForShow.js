...
module.exports = (racketObj) => {
  ...
  newRacket['Khung vợt'] = racketObj.frame.join(' / ').toUpperCase();
  newRacket['Thân vợt'] = racketObj.shaft.join(' / ').toUpperCase();
  ...
  newRacket['Màu sắc'] = racketObj.color.join(' / ').toUpperCase();
  newRacket['Sản xuất tại'] = racketObj.madein.toUpperCase();
